...
def face_emotion():
  logging.info("Starting Face emotion app...")
  ...
  webrtc_streamer(key='face emotion recognition',
                  mode=WebRtcMode.SENDRECV,rtc_configuration=RTC_CONFIGURATION,
...
#   page_func()
#   st.sidebar.markdown("---")
#   # logging.info("=== Alive threads ===")
#   # for thread in threading.enumerate():
#   #   if thread.is_alive():
#   #     logging.info(f"  {thread.name} ({thread.ident})")
